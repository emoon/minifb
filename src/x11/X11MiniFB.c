...
translate_key_code_b(int key_sym) {
    ...
    switch (key_sym) {
        case XK_KP_0:           return MFB_KB_KEY_KP_0;
        case XK_KP_1:           return MFB_KB_KEY_KP_1;
        case XK_KP_2:           return MFB_KB_KEY_KP_2;
        case XK_KP_3:           return MFB_KB_KEY_KP_3;
        case XK_KP_4:           return MFB_KB_KEY_KP_4;
        case XK_KP_5:           return MFB_KB_KEY_KP_5;
        case XK_KP_6:           return MFB_KB_KEY_KP_6;
        case XK_KP_7:           return MFB_KB_KEY_KP_7;
        case XK_KP_8:           return MFB_KB_KEY_KP_8;
        case XK_KP_9:           return MFB_KB_KEY_KP_9;
        case XK_KP_Separator:
        case XK_KP_Decimal:     return MFB_KB_KEY_KP_DECIMAL;
        case XK_KP_Equal:       return MFB_KB_KEY_KP_EQUAL;
        case XK_KP_Enter:       return MFB_KB_KEY_KP_ENTER;
    }
...
translate_key_code_a(int key_sym) {
    switch (key_sym) {
        case XK_Escape:         return MFB_KB_KEY_ESCAPE;
        case XK_Tab:            return MFB_KB_KEY_TAB;
        case XK_Shift_L:        return MFB_KB_KEY_LEFT_SHIFT;
        case XK_Shift_R:        return MFB_KB_KEY_RIGHT_SHIFT;
        case XK_Control_L:      return MFB_KB_KEY_LEFT_CONTROL;
        case XK_Control_R:      return MFB_KB_KEY_RIGHT_CONTROL;
        case XK_Meta_L:
        case XK_Alt_L:          return MFB_KB_KEY_LEFT_ALT;
        case XK_Mode_switch:      // Mapped to Alt_R on many keyboards
        case XK_ISO_Level3_Shift: // AltGr on at least some machines
        case XK_Meta_R:
        case XK_Alt_R:          return MFB_KB_KEY_RIGHT_ALT;
        case XK_Super_L:        return MFB_KB_KEY_LEFT_SUPER;
        case XK_Super_R:        return MFB_KB_KEY_RIGHT_SUPER;
        case XK_Menu:           return MFB_KB_KEY_MENU;
        case XK_Num_Lock:       return MFB_KB_KEY_NUM_LOCK;
        case XK_Caps_Lock:      return MFB_KB_KEY_CAPS_LOCK;
        case XK_Print:          return MFB_KB_KEY_PRINT_SCREEN;
        case XK_Scroll_Lock:    return MFB_KB_KEY_SCROLL_LOCK;
        case XK_Pause:          return MFB_KB_KEY_PAUSE;
        case XK_Delete:         return MFB_KB_KEY_DELETE;
        case XK_BackSpace:      return MFB_KB_KEY_BACKSPACE;
        case XK_Return:         return MFB_KB_KEY_ENTER;
        case XK_Home:           return MFB_KB_KEY_HOME;
        case XK_End:            return MFB_KB_KEY_END;
        case XK_Page_Up:        return MFB_KB_KEY_PAGE_UP;
        case XK_Page_Down:      return MFB_KB_KEY_PAGE_DOWN;
        case XK_Insert:         return MFB_KB_KEY_INSERT;
        case XK_Left:           return MFB_KB_KEY_LEFT;
        case XK_Right:          return MFB_KB_KEY_RIGHT;
        case XK_Down:           return MFB_KB_KEY_DOWN;
        case XK_Up:             return MFB_KB_KEY_UP;
        case XK_F1:             return MFB_KB_KEY_F1;
        case XK_F2:             return MFB_KB_KEY_F2;
        case XK_F3:             return MFB_KB_KEY_F3;
        case XK_F4:             return MFB_KB_KEY_F4;
        case XK_F5:             return MFB_KB_KEY_F5;
        case XK_F6:             return MFB_KB_KEY_F6;
        case XK_F7:             return MFB_KB_KEY_F7;
        case XK_F8:             return MFB_KB_KEY_F8;
        case XK_F9:             return MFB_KB_KEY_F9;
        case XK_F10:            return MFB_KB_KEY_F10;
        case XK_F11:            return MFB_KB_KEY_F11;
        case XK_F12:            return MFB_KB_KEY_F12;
        case XK_F13:            return MFB_KB_KEY_F13;
        case XK_F14:            return MFB_KB_KEY_F14;
        case XK_F15:            return MFB_KB_KEY_F15;
        case XK_F16:            return MFB_KB_KEY_F16;
        case XK_F17:            return MFB_KB_KEY_F17;
        case XK_F18:            return MFB_KB_KEY_F18;
        case XK_F19:            return MFB_KB_KEY_F19;
        case XK_F20:            return MFB_KB_KEY_F20;
        case XK_F21:            return MFB_KB_KEY_F21;
        case XK_F22:            return MFB_KB_KEY_F22;
        case XK_F23:            return MFB_KB_KEY_F23;
        case XK_F24:            return MFB_KB_KEY_F24;
        case XK_F25:            return MFB_KB_KEY_F25;

        // Numeric keypad
        case XK_KP_Divide:      return MFB_KB_KEY_KP_DIVIDE;
        case XK_KP_Multiply:    return MFB_KB_KEY_KP_MULTIPLY;
        case XK_KP_Subtract:    return MFB_KB_KEY_KP_SUBTRACT;
        case XK_KP_Add:         return MFB_KB_KEY_KP_ADD;

        // These should have been detected in secondary keysym test above!
        case XK_KP_Insert:      return MFB_KB_KEY_KP_0;
        case XK_KP_End:         return MFB_KB_KEY_KP_1;
        case XK_KP_Down:        return MFB_KB_KEY_KP_2;
        case XK_KP_Page_Down:   return MFB_KB_KEY_KP_3;
        case XK_KP_Left:        return MFB_KB_KEY_KP_4;
        case XK_KP_Right:       return MFB_KB_KEY_KP_6;
        case XK_KP_Home:        return MFB_KB_KEY_KP_7;
        case XK_KP_Up:          return MFB_KB_KEY_KP_8;
        case XK_KP_Page_Up:     return MFB_KB_KEY_KP_9;
        case XK_KP_Delete:      return MFB_KB_KEY_KP_DECIMAL;
        case XK_KP_Equal:       return MFB_KB_KEY_KP_EQUAL;
        case XK_KP_Enter:       return MFB_KB_KEY_KP_ENTER;
        ...
        case XK_a:              return MFB_KB_KEY_A;
        case XK_b:              return MFB_KB_KEY_B;
        case XK_c:              return MFB_KB_KEY_C;
        case XK_d:              return MFB_KB_KEY_D;
        case XK_e:              return MFB_KB_KEY_E;
        case XK_f:              return MFB_KB_KEY_F;
        case XK_g:              return MFB_KB_KEY_G;
        case XK_h:              return MFB_KB_KEY_H;
        case XK_i:              return MFB_KB_KEY_I;
        case XK_j:              return MFB_KB_KEY_J;
        case XK_k:              return MFB_KB_KEY_K;
        case XK_l:              return MFB_KB_KEY_L;
        case XK_m:              return MFB_KB_KEY_M;
        case XK_n:              return MFB_KB_KEY_N;
        case XK_o:              return MFB_KB_KEY_O;
        case XK_p:              return MFB_KB_KEY_P;
        case XK_q:              return MFB_KB_KEY_Q;
        case XK_r:              return MFB_KB_KEY_R;
        case XK_s:              return MFB_KB_KEY_S;
        case XK_t:              return MFB_KB_KEY_T;
        case XK_u:              return MFB_KB_KEY_U;
        case XK_v:              return MFB_KB_KEY_V;
        case XK_w:              return MFB_KB_KEY_W;
        case XK_x:              return MFB_KB_KEY_X;
        case XK_y:              return MFB_KB_KEY_Y;
        case XK_z:              return MFB_KB_KEY_Z;
        case XK_1:              return MFB_KB_KEY_1;
        case XK_2:              return MFB_KB_KEY_2;
        case XK_3:              return MFB_KB_KEY_3;
        case XK_4:              return MFB_KB_KEY_4;
        case XK_5:              return MFB_KB_KEY_5;
        case XK_6:              return MFB_KB_KEY_6;
        case XK_7:              return MFB_KB_KEY_7;
        case XK_8:              return MFB_KB_KEY_8;
        case XK_9:              return MFB_KB_KEY_9;
        case XK_0:              return MFB_KB_KEY_0;
        case XK_space:          return MFB_KB_KEY_SPACE;
        case XK_minus:          return MFB_KB_KEY_MINUS;
        case XK_equal:          return MFB_KB_KEY_EQUAL;
        case XK_bracketleft:    return MFB_KB_KEY_LEFT_BRACKET;
        case XK_bracketright:   return MFB_KB_KEY_RIGHT_BRACKET;
        case XK_backslash:      return MFB_KB_KEY_BACKSLASH;
        case XK_semicolon:      return MFB_KB_KEY_SEMICOLON;
        case XK_apostrophe:     return MFB_KB_KEY_APOSTROPHE;
        case XK_dead_acute:     return MFB_KB_KEY_APOSTROPHE;
        case XK_dead_diaeresis: return MFB_KB_KEY_APOSTROPHE;
        case XK_grave:          return MFB_KB_KEY_GRAVE_ACCENT;
        case XK_dead_grave:     return MFB_KB_KEY_GRAVE_ACCENT;
        case XK_dead_circumflex:return MFB_KB_KEY_GRAVE_ACCENT;
        case XK_dead_tilde:     return MFB_KB_KEY_GRAVE_ACCENT;
        case XK_comma:          return MFB_KB_KEY_COMMA;
        case XK_period:         return MFB_KB_KEY_PERIOD;
        case XK_slash:          return MFB_KB_KEY_SLASH;
        case XK_less:           return MFB_KB_KEY_WORLD_1; // At least in some layouts...
        default:                break;
    }
...
init_keycodes(SWindowData_X11 *window_data_specific) {
    ...
    for (i=8; i<=255; ++i) {
        // Try secondary keysym, for numeric keypad keys
         ...
         if (g_keycodes[i] == MFB_KB_KEY_UNKNOWN) {
