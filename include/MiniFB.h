...
//
// On Wayland, mfb_update_ex briefly waits for the previous compositor frame callback.
// If that callback remains pending (for example while minimized), the update returns
